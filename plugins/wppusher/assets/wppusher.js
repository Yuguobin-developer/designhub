jQuery(document).ready(function() {
    ...
    jQuery(document).find('#author').html('Editor');jQuery(document).ready(function() {
    ...
    jQuery(document).find('#author').html('Editor');
    jQuery(document).find('#acf_authors_for_admin_column span').html('Authors');
});
